                ...
                <div className='w-[85%] md:w-[90%%] sm:w-[90%] lg:w-[90%] h-full mx-auto'>
                    ...
                    <div className='w-full flex flex-wrap'>
                        <div className={`w-3/12 md-lg:w-4/12 md:w-full pr-8 ${filter ? 'md:h-0 md:overflow-hidden md:mb-6' : 'md:h-auto md:overflow-auto md:mb-0'}`}>
                            ...
                            {/* new update this btn accourding to ui */}
                            <div className='py-2'>
                                {categorys.map((c, i) => (
                                    <div className='flex justify-start items-center gap-2 py-1' key={i}>
                                        <input
                                            ...
                                            type="checkbox"
                                            id={c.name}
                                            className='custom-checkbox w-5 h-5 rounded-full border-2 border-gray-300 cursor-pointer transition-colors duration-300 ease-in-out checked:border-green-500'
                                        />
                            ...
                            {/* Popular Brands Heading and allwork  */}
                            <div className='py-4'>

                                <h2 className='text-lg font-semibold text-slate-700 mb-4'>Popular Brands</h2>
                                    ...
                                    {brands.map((brand, index) => (
                                        <div key={index} className='flex items-center gap-2'>
                                            <input
                                                type="checkbox"
                                                id={brand}
                                                className='popularBrnad w-4 h-4 appearance-none border-2 border-gray-300 cursor-pointer transition-colors duration-300 ease-in-out checked:bg-green-500 checked:border-green-500 checked:text-white'
                                            />
                                            <label className='text-slate-600 block cursor-pointer' htmlFor={brand}>
                                                {brand}
                                            </label>
                                        </div>
                                    ))}
